...
lookup_module = Extension(
    "line_aware_stat.gen_lookup",
    [
        "src/soapcw/line_aware_stat/gen_lookup.pyx",
        "src/soapcw/line_aware_stat/integrals.cpp",
    ],
    language="c++",
...
if cpp:
    ext_modules = [
        Extension("soapcw.soap", ["src/soapcw/soap.pyx"]),
        lookup_module,
    ]
else:
    ext_modules = [
