...
class TestSoap(unittest.TestCase):
    ...
    def test_transition_matrix_1d(self):
        ...
        transition = np.array(
            [-1.3862943611198906, -0.6931471805599453, -1.3862943611198906]
        )
    ...
    def test_transition_matrix_2d(self):
        ...
        np.testing.assert_almost_equal(
            tr_2d, soap.tools.transition_matrix_2d(2, 1e100, 1e100)
        )
    ...
    def test_basic_single(self):
        ...
        output_map = np.array(
            [
                ...
                [3.0, 4.0, 5.0, 6.0, 7.0],
                [9.0, 9.0, 9.0, 9.0, 9.0],
                [11.0, 15.0, 14.0, 13.0, 16.0],
                [22.0, 19.0, 21.0, 19.0, 22.0],
            ]
        )
