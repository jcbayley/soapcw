...
def train_cnn(
    traindir, model_dir, snr, norm_stat=False, norm_sft=False, vitmap_dir=None, stat_dir=None
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-vitmap", "--vitmap-dir", help="directory to vitmap model", type=str, required=False
    )
    parser.add_argument(
