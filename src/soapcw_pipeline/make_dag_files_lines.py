...
def write_dagfile(config_file, config, verbose=False):
    ...
    write_plot_subfile(
        run_sub_filename, config, config_file, condor_dirs, run_sub_comment, verbose=verbose
    )
    write_html_subfile(
        html_sub_filename, config, config_file, condor_dirs, html_sub_comment, verbose=verbose
    )
